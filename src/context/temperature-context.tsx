...
import type { TemperatureData } from '../lib/temperature-data-types'
import { addMaxMinValues } from '../utils/addMaxMinValues'
...
export type TimeRange = '1M' | '6M' | '1J' | 'Max'
...
export function TemperatureProvider({ children }: { children: React.ReactNode }) {
  ...
  const { data: tempData, maxTemp, minTemp } = useMemo(() => addMaxMinValues(searchTermData), [searchTermData])
